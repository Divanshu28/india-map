...
const INDIA_TOPO_JSON = require('../data/india_topo.json');
...
const getHeatMapData = () => {
  return [
    ...
    { id: 'JK', state: 'Jammu and Kashmir', value: 10003},
    { id: 'LA', state: 'Ladakh', value: 60 },
...
function IndiaMap() {
  ...
  return (
    <div className="full-width-height container">
      <h1 className="no-margin center" align="center">States and UTs</h1>
        <ComposableMap
